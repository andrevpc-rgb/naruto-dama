...
const userSchema = new mongoose.Schema({
  ...
  // default 'Uzumaki': contas antigas (criadas antes desse campo existir) não têm "clan" salvo no banco.
  // Sem o default, o próximo user.save() delas (ex: em report_match_result, ao creditar pontos de uma
  // vitória) falharia na validação do "required" e a pontuação simplesmente não seria salva.
  clan: { type: String, required: true, enum: CLANS, default: 'Uzumaki' },
